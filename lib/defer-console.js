import { BOLD, DEFAULT, NORMAL, NORMAL_ITALIC, } from './consts';
...
export default function (options = {}) {
    ...
    function autoConsoleGroup() {
        ...
        console[isCollapsed() ? 'groupCollapsed' : 'group'](`%c${config.label}%c ${getEvent(config)} %c${groupStartTime()}`, NORMAL, BOLD, NORMAL_ITALIC);
